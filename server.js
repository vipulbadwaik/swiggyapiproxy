...
app.get('/api/swiggy-list', (req, res) => {
    const url = `https://www.swiggy.com/dapi/restaurants/list/v5?lat=${LAT1}&lng=${LNG1}&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING`;
